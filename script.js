...
window.addLog = async (id) => {
    ...
    // Find the current logs for this specific ID
        ...
        return `
            <div class="border-b">
                <div onclick="toggleCust('${name}')" class="p-5 flex justify-between items-center cursor-pointer hover:bg-slate-50">
                    <span class="text-lg font-black uppercase">${name}</span>
                                ...
                                <tr>
                                    ...
                                    <td class="p-3 border-r">
                                        ...
                                        <div class="flex gap-1">
                                            <input id="log-in-${j.id}" placeholder="NEW LOG..." class="flex-1 border p-1 rounded text-[10px] uppercase font-semibold outline-none">
